...
import 'package:sooyaa_app/core/Services/api_services.dart';
import 'package:sooyaa_app/core/Services/end_points.dart';
import 'package:sooyaa_app/core/cubit/word_learned/word_learned_states.dart';
import 'package:sooyaa_app/core/model/word_list_model.dart';
...
class WordLearnedCubit extends Cubit<WordLearnedStates> {
  ...
  Future<void> getWordsList() async {
    ...
    try {
      ...
      wordListModel = (value.data as List)
          .map((e) => WordListModel.fromJson(e))
          .toList();
